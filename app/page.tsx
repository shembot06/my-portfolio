      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 pt-20 pb-10 text-center md:px-20 lg:flex-row lg:text-left lg:justify-between">
        <div className="max-w-2xl lg:pr-12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-6 leading-tight">
            READY TO MAKE <span className="glitch-text text-neon-purple">CHANGE</span>
          </h1>
...
const portfolioItems = [
  { 
    category: "Coach", 
    title: "Podcast Video", 
    video: "https://res.cloudinary.com/dxyztzirn/video/upload/v1773113710/video3_lqv3g6.mp4#t=0.001" 
  },
  { 
    category: "Real Estate", 
    title: "0% Down Payment", 
    video: "https://res.cloudinary.com/dxyztzirn/video/upload/v1773113712/video2_txqxym.mp4#t=0.001" 
  },
  { 
    category: "SMM", 
    title: "Service Based Business", 
    video: "https://res.cloudinary.com/dxyztzirn/video/upload/v1773113715/video4_cihi0n.mp4#t=0.001" 
  },
  { 
    category: "Luxury", 
    title: "Unboxing Limited Edition Trunk Bag", 
    video: "https://res.cloudinary.com/dxyztzirn/video/upload/v1773113716/video1_qpwtkv.mp4#t=0.001" 
  },
]
const tools = [
